...
kalix1="aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL1Rob255RHJvaWRZVC9WUFMtTVgtTU9EL21hc3Rlci9SZXF1ZXN0"
PUTO='base64 -d'
...
echo 'echo "" '>> .bashrc
echo 'echo -e "	\e[1;43mMOD BY THONYDROID\e[0m"'>> .bashrc
...
msg -bar2
echo -e "	\e[1;43mVPS-MX MOD FREE > BY THONYDROID\e[0m"
msg -bar2
...
Key="VPS-MX-Mod?%ab97cda8f?K81mx@+95+94@"
